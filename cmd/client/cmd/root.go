...
func init() {
	...
	//rootCmd.PersistentFlags().StringVar(&adduser, "adduser", "", "add a user to the Todo application")
	//rootCmd.PersistentFlags().StringVar(&deleteuser, "deleteuser", "", "add a user to the Todo application")
